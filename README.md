...
hanna_db/ 
├── produse (codp, nume, pret, descriere, imagine, tip) 
└── Coșul gestionat prin sesiuni PHP (codp, nume, pret, cantitate, imagine, subtotal) 
...
6. Fallback for JavaScript: Full functionality
...
├── imagini/               # Product graphic resources 
└── js/ 
